    ...
    public void onPotionEffectExpire(PotionEffectExpireEvent event) {
        ...
        if (livingEntity instanceof Player) {
            ...
            if (previous != null && previous.getDuration() < 1_000_000) {
                ...
                // restore enchants after effect restored
                Bukkit.getScheduler().runTaskLater(Foxtrot.getInstance(), () -> FixListener.refreshCustomEnchants(player), previous.getDuration() + 2);
            }
        }
    }
