...
public class InventoryUtils {
    ...
    public static final ItemStack ZOMBIE_SPAWNER = ItemBuilder.of(Material.MOB_SPAWNER).name(CC.GREEN + CC.BOLD + "Zombie Spawner").build();
    public static final ItemStack SKELETON_SPAWNER = ItemBuilder.of(Material.MOB_SPAWNER).name(CC.GREEN + CC.BOLD + "Skeleton Spawner").build();
    public static final ItemStack SPIDER_SPAWNER = ItemBuilder.of(Material.MOB_SPAWNER).name(CC.GREEN + CC.BOLD + "Spider Spawner").build();
    public static final ItemStack CAVE_SPIDER_SPAWNER = ItemBuilder.of(Material.MOB_SPAWNER).name(CC.GREEN + CC.BOLD + "Cave Spider Spawner").build();
