...
import net.frozenorb.foxtrot.bounty.BountyManager;
...
public class MapHandler {
    ...
    @Getter
    private BlockShopHandler blockShopHandler;
    @Getter
...
//            }
        ...
        blockShopHandler = new BlockShopHandler();
    ...
    private BasicDBObject getDefaults() {
        ...
        dbObject.put("scoreboardTitle", "&4&lValor &c[Map 1]");
