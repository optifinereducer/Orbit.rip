...
import net.frozenorb.foxtrot.listener.PurgeListener;
...
public class EventHandler {
	...
	public EventHandler() {
		...
		Foxtrot.getInstance().getServer().getPluginManager().registerEvents(new PurgeListener(), Foxtrot.getInstance());
